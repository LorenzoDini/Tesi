...
//Questa è la versione in cui dovrebbe funzionare anche il calcolo dell'errore di c, l'ho provata a mano. Mi rimane da aggiungere la modifica III degli appunti e la lettura adattata al jackknife a blocchi. In più ho messo la deallocazione, funziona uguale (fatto la prova con i dati a B=18 e non cambia nulla)
