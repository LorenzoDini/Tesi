//Questa è la versione presa da quella funzionante e pulita, ma dove dorvrò fare le correzioni di BigFra e forse qualcosina è già stata modificata, in più ci sono  le modifiche per farlo funzionare con il tot_pollo, che è il file output moltiplicato
